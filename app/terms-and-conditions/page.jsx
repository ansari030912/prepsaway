            ...
            <div className="w-full md:w-7/12 px-4">
              ...
              <div className="flex items-center -mx-2">
                <div className="w-auto px-2">
                  ...
                  <p className="text-base md:text-lg text-gray-500">21 May 2025</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap -mx-4">
            ...
            <div className="w-full md:flex-1 px-4">
              <p className="mb-8 md:mb-12 text-lg font-base text-gray-500">
                PrepsAway.com (referred to as the &quot;Company&quot;,
                &quot;we&quot;, &quot;us&quot;, &quot;our&quot;) operates the
                website https://prepsaway.com, including all subsidiary pages
              ...
              <p className="mb-8 text-lg md:text-xl font-medium text-gray-500">
                ...
                For any inquiries, please contact us at sales@prepsaway.com.
              </p>
            </div>
          </div>
        </div>
...
export async function generateMetadata() {
  return {
    title: `PrepsAway Terms & Conditions`,
    ...
    alternates: {
      canonical: "https://prepsaway.com/terms-and-conditions",
    },
  };
}
